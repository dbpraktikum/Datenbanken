...
public class FluechtlingeInKreis_ScrollableJTable extends javax.swing.JFrame{	
	...
	public FluechtlingeInKreis_ScrollableJTable(String kreis, String databaseUsername, String databasePassword) throws SQLException{
        ...
        int n = 0;
        ResultSet testLaenge = Functions.fluechtlingeInKreis(DatabaseConnector.connectToDatabase(databaseUsername, databasePassword), kreis);
        ...
        ResultSet rs = Functions.fluechtlingeInKreis(DatabaseConnector.connectToDatabase(databaseUsername, databasePassword), kreis);
